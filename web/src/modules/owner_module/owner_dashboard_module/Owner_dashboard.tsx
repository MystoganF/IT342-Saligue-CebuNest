      ...
      <div className={styles.drawer} role="dialog" aria-modal="true" aria-label={meta.label}>
              ...
              <tbody>
                {pageEntries.map((entry, idx) => (
                  ...
                  >
                    ...
                    <td>
                      <div
                        className={styles.drawerInstallBadge}
                        style={{ background: meta.bg, color: meta.color }}
                      >
                        <span className={styles.drawerInstallNum}>
                          {entry.installmentNumber}
                        </span>
                        <span className={styles.drawerInstallOf}>
                          of {entry.totalInstallments}
                        </span>
                      </div>
                    </td>
                    ...
                    <td>
                      {status === "paid" ? (
                        ...
                        <span
                          className={styles.drawerStatusPill}
                          style={{ background: meta.bg, color: meta.color }}
                        >
        ...
        {totalPages > 1 && (
          <div className={styles.drawerPager}>
            <button
              className={styles.drawerPagerBtn}
    ...
    <div className={styles.page}>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.analyticsGrid}>
          ...
          {/* ── Payment Status Card — summary only, rows open the drawer ── */}
          <div className={styles.analyticCard}>
            <div className={styles.analyticCardHeader}>
              <div>
                <div className={styles.sectionEyebrow}>
