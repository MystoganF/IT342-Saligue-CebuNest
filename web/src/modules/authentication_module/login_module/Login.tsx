      ...
      <div className={styles.leftPanel}>
        ...
        <div className={styles.brandInfo}>
          ...
          <p className={styles.brandBody}>
            Streamlined rental management for tenants and property owners. Browse listings, submit rental requests, and
      ...
      <div className={styles.rightPanel}>
        <div className={styles.formCard}>
          ...
          <div className={styles.links}>
            ...
            <a href="/register" className={`${styles.link} ${styles.linkSignup}`}>
              Create Account →
            </a>
          </div>
        </div>
