...
import { VirtuosoGrid } from "react-virtuoso"; // <-- NEW IMPORT
import {
  Search,
  AlertTriangle,
  Home,
  ...
  return (
    <div className={styles.page}>
      ...
      <main className={styles.main}>
        ...
        {/* ── GRID AREA (Replaced with VirtuosoGrid) ── */}
        {loading ? (
          ...
          <>
            {/* The actual Virtualizer */}
            <VirtuosoGrid
              useWindowScroll
              data={visible}
              // This applies your exact CSS grid classes to the wrapper elements generated by Virtuoso
              components={{
              ...
              itemContent={(index, p) => (
                <PropertyCard
                  property={p}
                  index={index}
                  isPriority={index < 6} // The first 6 cards will load their images instantly
                  onClick={openDetail}
                />
              )}
            />
